...
task_names = {...
    % 'Simulated_Independent_Input_A_B', ...
    % 'Simulated_Same_Input_A_B', ...
    % 'Simulated_Same_Input_Unconnected_A_B', ...
    % 'Simulated_Independent_Input_A_B_repeat', ...
    % 'Simulated_Same_Input_A_B_repeat', ...
    % 'Simulated_Same_Input_Unconnec    ted_A_B_repeat', ...
    % 'Simulated_Indirect_Input_A_B_Repeat',
    'Simulated_Indirect_Input_A_B_Repeat_222',
    % 'Simulated_Direct_Input_A_B_Repeat',
    };

% n_sessions = [100, 20, 20];
% n_sessions = [25, 15, 15];
% n_sessions = [100, 75, 75];
n_sessions = [150];
...
for task_idx=1:length(task_names)
    n_session = n_sessions(task_idx);
    session_idxs = 1:n_session;
