...
enum DATA_TYPE {
  ...
  DF_FLAG, DF_CHAR, DF_INT, DF_SHORT, DF_FLOAT, DF_STRUCTURE, 
  DF_STRING, DF_INT_ARRAY, DF_SHORT_ARRAY, DF_FLOAT_ARRAY,
...
void dfRecordInt(unsigned char, int);
...
void dfRecordIntArray(unsigned char, int, int *);
...
void dfuAddDynListInt(DYN_LIST *, int);
...
void dfuPrependDynListInt(DYN_LIST *, int);
...
int dfuInsertDynListInt(DYN_LIST *, int, int pos);
