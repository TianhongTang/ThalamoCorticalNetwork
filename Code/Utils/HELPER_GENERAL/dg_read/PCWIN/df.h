...
typedef struct {
  ...
  long time;			/* seconds since Jan. 1, 1970, 00:00   */
...
typedef struct {
  ...
  long date_time;                     /* date/time cell was isolated       */
...
void dfRecordLong(unsigned char, long);
...
void dfRecordLongArray(unsigned char, int, long *);
...
void dfuAddDynListLong(DYN_LIST *, long);
...
void dfuPrependDynListLong(DYN_LIST *, long);
...
int dfuInsertDynListLong(DYN_LIST *, long, int pos);
