...
%  JP - 21-05-2003 handling of dummy scans
...
pars.sligap		= acqp.IMND_slicepack_gap;
      ...
      %% info about dummy scans
pars.dstime = acqp.IMND_dscan_time;    % [s]
if strncmp(acqp.EPI_TC_mode, 'Set_TCnF',8)
  dsPackageCount = acqp.EPI_nav_DS;
  dsExcitationCount = acqp.EPI_navAU_DS;
  pars.ds = dsExcitationCount;     
else
  pars.ds = acqp.IMND_dscans;     
end
...
pars.times.expTime = acqp.ACQ_time;
pars.times.expAbsTime = acqp.ACQ_abs_time;
