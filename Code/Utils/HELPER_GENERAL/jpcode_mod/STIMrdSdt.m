...
BYTEORDER_DEFAULT = 'ieee-be';     % 'ieee-be' big endian for PC
...
switch deblank(strjust( endianStr ,'left'))
    case 'ieee-le'
        BYTEORDER = 'ieee-le';
    case 'ieee-be'
        BYTEORDER = 'ieee-be';
