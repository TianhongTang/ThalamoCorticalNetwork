...
acqp.SignalType = '';
acqp.PVM_EpiNShots = 0;
acqp.EffectiveTE = 0;
acqp.MP_AcqSize = 0;
acqp.PVM_EffSWh = 0;
acqp.PVM_SliceThick = 0;
acqp.PVM_SpatResol = [0 0];
acqp.PVM_Matrix = [0 0];
acqp.PVM_Fov = [0 0];
acqp.PVM_FovCm = [0 0];
acqp.PVM_SPackArrSliceOrient = '';
acqp.PVM_SPackArrReadOrient = '';
acqp.PVM_SPackArrReadOrient = '';
acqp.PVM_SPackArrSliceGap = -1;
acqp.PVM_SPackArrNSlices = 0;
acqp.PVM_SPackArrSliceDistance = 0;
acqp.PVM_ObjOrderList = [];
acqp.PVM_ObjOrderScheme = '';
acqp.PVM_MajSliceOri = '';
acqp.ACQ_operator = '';
acqp.ACQ_station = '';
