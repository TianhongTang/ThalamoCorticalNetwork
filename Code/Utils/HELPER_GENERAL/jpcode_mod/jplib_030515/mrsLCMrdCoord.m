% function mrsLCMrdCoordTest(dir, filenum, optin);
% 
% global testdat
% 
% if nargin < 1
...
%     %mrsLCMWrite('juchem_tes.dv1', 14, opt('BASIS','4T_MAC', 'TRAMP',1,'VOLUME',1,...
%     %    'LSHIFT',63,'DEGZER',0,'DEGPPM',0,'PPMST',4.2,'PPMEND',0.1,'VERBOSE',2) );
%     mrsLCMWrite(testdat, opt('BASIS','7T_MAC', 'TRAMP',1.41,'VOLUME',1,'CHOMIT',{'Ala' 'Asp' 'Gly'},...
%         'LSHIFT',0,'DEGZER',0,'DEGPPM',0,'PPMST',4.5,'PPMEND',0.1,'VERBOSE',2) );
% end
%     
%--------------------------------------------------------------
function mrsLCMrdCoord(mrsDat, optin);
% %  mrsLCMWrite(mrsDat, optin)
% %
% %  Bruker ParaVision
% %  converts MRS data file to LCModel format
% %
% %  default options:
% %     opt(   'DIRAPP', '',
% %            'TWODIM', 0,
...
PATHBASISSET = '/usr/local/mpi/LCModel/basis-sets/';
VERSION = ' mrsLCMWrite() - JP Nov 2002';
