function [adfreq, n, ts, fn, ad] = plx_ad_vedit(filename, ch)
% PLX_AD_V  Mimic the behavior of Plexon's .plx file reading function
% Read in the slow data from a .plx file, in mV.
% 
% INPUT:
...
fullplx = iplx_mimichelperedit(filename);
...
n = sum(fn);
ad = vertcat(fullplx.Slow(chindx).Data{:});