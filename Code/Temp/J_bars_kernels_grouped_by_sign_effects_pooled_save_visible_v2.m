...
% 'visible' = show figures and do not save.
% 'save'    = hide figures, export to Figures/Paper/J_bars, then close.
...
setappdata(0, 'JBarsExportFigures', export_figures);
...
for injection_idx = 1:numel(injection_types)
    ...
    f1 = figure('Position', [100, 100, 1200, 800], 'Visible', get_jbars_figure_visible());
    ...
    f2 = figure('Position', [100, 100, 1200, 800], 'Visible', get_jbars_figure_visible());
...
function export_figures = get_jbars_export_figures()
    if isappdata(0, 'JBarsExportFigures')
        export_figures = getappdata(0, 'JBarsExportFigures');
    else
        export_figures = true;
    end
end
