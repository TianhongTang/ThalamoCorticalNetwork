...
n_row = 4; %#ok<NASGU>
n_col = 4; %#ok<NASGU>
figure_visible = 'off'; %#ok<NASGU>
show_legend = true; %#ok<NASGU>
show_inset_stat = false; %#ok<NASGU>
show_identity_line = false; %#ok<NASGU>
show_fit_line = true; %#ok<NASGU>
fit_line_method = 'tls'; %#ok<NASGU>

preferred_example_session_index = 12;
...
base_params.preferred_example_session_index = preferred_example_session_index;
...
for hp_i = 1:numel(hyperparam_configs)
    ...
    try
        ...
        cache_file = fullfile(cache_folder, 'precomputed_figure3.mat');
        precomputed = struct();
        precomputed.hp = hp;
        precomputed.params = base_params;
        ...
        warning('Skipping hyperparameter configuration %d/%d after error: %s', hp_i, numel(hyperparam_configs), ME.message);
        continue;
    end
end
