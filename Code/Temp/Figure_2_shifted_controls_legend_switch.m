...
% figure: same Column structure as Figure 1.
...
for i = 1:n_state
    ...
    % Column 4/5 spectra are computed from the original population signals with
    ...
    %% Column 2: population cross-correlogram with shifted control and significant segments.
    column = 2;
    tile = nexttile(column + n_column*(i-1));
    ...
    %% Column 6: population spectral coherence with shuffled control.
